...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.TagResults();
  });
  ...
  describe('TagResults', function() {
    it('should create an instance of TagResults', function() {
      // uncomment below and update the code to test TagResults
      //var instance = new radiomanager.TagResults();
      //expect(instance).to.be.a(radiomanager.TagResults);
    });
