...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.BlockResult();
  });
  ...
  describe('BlockResult', function() {
    it('should create an instance of BlockResult', function() {
      // uncomment below and update the code to test BlockResult
      //var instance = new radiomanager.BlockResult();
      //expect(instance).to.be.a(radiomanager.BlockResult);
    });
