...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.StoryDataInput();
  });
  ...
  describe('StoryDataInput', function() {
    it('should create an instance of StoryDataInput', function() {
      // uncomment below and update the code to test StoryDataInput
      //var instance = new radiomanager.StoryDataInput();
      //expect(instance).to.be.a(radiomanager.StoryDataInput);
    });
