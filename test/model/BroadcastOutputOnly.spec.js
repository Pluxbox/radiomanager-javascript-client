...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.BroadcastOutputOnly();
  });
  ...
  describe('BroadcastOutputOnly', function() {
    it('should create an instance of BroadcastOutputOnly', function() {
      // uncomment below and update the code to test BroadcastOutputOnly
      //var instance = new radiomanager.BroadcastOutputOnly();
      //expect(instance).to.be.a(radiomanager.BroadcastOutputOnly);
    });
