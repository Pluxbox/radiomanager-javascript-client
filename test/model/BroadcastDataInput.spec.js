...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.BroadcastDataInput();
  });
  ...
  describe('BroadcastDataInput', function() {
    it('should create an instance of BroadcastDataInput', function() {
      // uncomment below and update the code to test BroadcastDataInput
      //var instance = new radiomanager.BroadcastDataInput();
      //expect(instance).to.be.a(radiomanager.BroadcastDataInput);
    });
