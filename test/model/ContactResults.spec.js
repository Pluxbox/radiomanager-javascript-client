...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.ContactResults();
  });
  ...
  describe('ContactResults', function() {
    it('should create an instance of ContactResults', function() {
      // uncomment below and update the code to test ContactResults
      //var instance = new radiomanager.ContactResults();
      //expect(instance).to.be.a(radiomanager.ContactResults);
    });
