...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.ContactOutputOnly();
  });
  ...
  describe('ContactOutputOnly', function() {
    it('should create an instance of ContactOutputOnly', function() {
      // uncomment below and update the code to test ContactOutputOnly
      //var instance = new radiomanager.ContactOutputOnly();
      //expect(instance).to.be.a(radiomanager.ContactOutputOnly);
    });
