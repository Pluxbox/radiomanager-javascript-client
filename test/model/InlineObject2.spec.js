...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.InlineObject2();
  });
  ...
  describe('InlineObject2', function() {
    it('should create an instance of InlineObject2', function() {
      ...
      //var instance = new radiomanager.InlineObject2();
      //expect(instance).to.be.a(radiomanager.InlineObject2);
    });
    ...
    it('should have the property beforeId (base name: "before_id")', function() {
