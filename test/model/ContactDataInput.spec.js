...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.ContactDataInput();
  });
  ...
  describe('ContactDataInput', function() {
    it('should create an instance of ContactDataInput', function() {
      // uncomment below and update the code to test ContactDataInput
      //var instance = new radiomanager.ContactDataInput();
      //expect(instance).to.be.a(radiomanager.ContactDataInput);
    });
