...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.BlockResults();
  });
  ...
  describe('BlockResults', function() {
    it('should create an instance of BlockResults', function() {
      // uncomment below and update the code to test BlockResults
      //var instance = new radiomanager.BlockResults();
      //expect(instance).to.be.a(radiomanager.BlockResults);
    });
