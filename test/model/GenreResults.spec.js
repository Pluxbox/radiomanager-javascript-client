...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.GenreResults();
  });
  ...
  describe('GenreResults', function() {
    it('should create an instance of GenreResults', function() {
      // uncomment below and update the code to test GenreResults
      //var instance = new radiomanager.GenreResults();
      //expect(instance).to.be.a(radiomanager.GenreResults);
    });
