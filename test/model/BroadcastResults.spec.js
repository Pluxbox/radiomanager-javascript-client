...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.BroadcastResults();
  });
  ...
  describe('BroadcastResults', function() {
    it('should create an instance of BroadcastResults', function() {
      // uncomment below and update the code to test BroadcastResults
      //var instance = new radiomanager.BroadcastResults();
      //expect(instance).to.be.a(radiomanager.BroadcastResults);
    });
