...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.ProgramResults();
  });
  ...
  describe('ProgramResults', function() {
    it('should create an instance of ProgramResults', function() {
      // uncomment below and update the code to test ProgramResults
      //var instance = new radiomanager.ProgramResults();
      //expect(instance).to.be.a(radiomanager.ProgramResults);
    });
