...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.GroupRelations();
  });
  ...
  describe('GroupRelations', function() {
    it('should create an instance of GroupRelations', function() {
      // uncomment below and update the code to test GroupRelations
      //var instance = new radiomanager.GroupRelations();
      //expect(instance).to.be.a(radiomanager.GroupRelations);
    });
