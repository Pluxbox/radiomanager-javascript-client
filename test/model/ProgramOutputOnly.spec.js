...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.ProgramOutputOnly();
  });
  ...
  describe('ProgramOutputOnly', function() {
    it('should create an instance of ProgramOutputOnly', function() {
      // uncomment below and update the code to test ProgramOutputOnly
      //var instance = new radiomanager.ProgramOutputOnly();
      //expect(instance).to.be.a(radiomanager.ProgramOutputOnly);
    });
