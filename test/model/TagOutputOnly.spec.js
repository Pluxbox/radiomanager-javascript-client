...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.TagOutputOnly();
  });
  ...
  describe('TagOutputOnly', function() {
    it('should create an instance of TagOutputOnly', function() {
      // uncomment below and update the code to test TagOutputOnly
      //var instance = new radiomanager.TagOutputOnly();
      //expect(instance).to.be.a(radiomanager.TagOutputOnly);
    });
