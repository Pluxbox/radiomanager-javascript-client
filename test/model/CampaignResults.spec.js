...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.CampaignResults();
  });
  ...
  describe('CampaignResults', function() {
    it('should create an instance of CampaignResults', function() {
      // uncomment below and update the code to test CampaignResults
      //var instance = new radiomanager.CampaignResults();
      //expect(instance).to.be.a(radiomanager.CampaignResults);
    });
