...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new radiomanager.GenreApi();
  });
  ...
  describe('GenreApi', function() {
    describe('getGenreById', function() {
      it('should call getGenreById successfully', function(done) {
        //uncomment below and update the code to test getGenreById
        //instance.getGenreById(function(error) {
