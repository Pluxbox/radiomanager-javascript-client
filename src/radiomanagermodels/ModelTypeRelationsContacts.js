...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ModelTypeRelationsContacts
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeRelationsContacts</code>.
   * @alias module:radiomanagermodels/ModelTypeRelationsContacts
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ModelTypeRelationsContacts} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ModelTypeRelationsContacts} The populated <code>ModelTypeRelationsContacts</code> instance.
   */
