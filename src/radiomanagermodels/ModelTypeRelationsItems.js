...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ModelTypeRelationsItems
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeRelationsItems</code>.
   * @alias module:radiomanagermodels/ModelTypeRelationsItems
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ModelTypeRelationsItems} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ModelTypeRelationsItems} The populated <code>ModelTypeRelationsItems</code> instance.
   */
