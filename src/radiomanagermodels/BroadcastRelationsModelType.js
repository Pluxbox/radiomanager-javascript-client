...
(function(root, factory) {
   ...
   * @module radiomanagermodels/BroadcastRelationsModelType
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastRelationsModelType</code>.
   * @alias module:radiomanagermodels/BroadcastRelationsModelType
   * @class
   */
   ...
   * @param {module:radiomanagermodels/BroadcastRelationsModelType} obj Optional instance to populate.
   * @return {module:radiomanagermodels/BroadcastRelationsModelType} The populated <code>BroadcastRelationsModelType</code> instance.
   */
