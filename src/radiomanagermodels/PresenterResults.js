...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/PresenterResult'], factory);
   ...
   * @module radiomanagermodels/PresenterResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterResults</code>.
   * @alias module:radiomanagermodels/PresenterResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/PresenterResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/PresenterResults} The populated <code>PresenterResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/PresenterResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/PresenterResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/PresenterResult>} results
   */
