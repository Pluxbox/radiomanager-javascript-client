...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ProgramRelationsBroadcasts
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramRelationsBroadcasts</code>.
   * @alias module:radiomanagermodels/ProgramRelationsBroadcasts
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ProgramRelationsBroadcasts} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ProgramRelationsBroadcasts} The populated <code>ProgramRelationsBroadcasts</code> instance.
   */
