...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ReadOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>ReadOnly</code>.
   * @alias module:radiomanagermodels/ReadOnly
   * @class
   ...
   * @param {module:radiomanagermodels/ReadOnly} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ReadOnly} The populated <code>ReadOnly</code> instance.
   */
