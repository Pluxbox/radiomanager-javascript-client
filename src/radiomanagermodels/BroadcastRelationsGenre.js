...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.radiomanager.BroadcastRelationsGenre = factory(root.radiomanager.ApiClient, root.radiomanager.BlockRelationsBroadcastParams);
  }
   ...
   * @module radiomanagermodels/BroadcastRelationsGenre
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastRelationsGenre</code>.
   * @alias module:radiomanagermodels/BroadcastRelationsGenre
   * @class
   */
   ...
   * @param {module:radiomanagermodels/BroadcastRelationsGenre} obj Optional instance to populate.
   * @return {module:radiomanagermodels/BroadcastRelationsGenre} The populated <code>BroadcastRelationsGenre</code> instance.
   */
