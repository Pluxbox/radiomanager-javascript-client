...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ModelTypeRelationsPrograms
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeRelationsPrograms</code>.
   * @alias module:radiomanagermodels/ModelTypeRelationsPrograms
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ModelTypeRelationsPrograms} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ModelTypeRelationsPrograms} The populated <code>ModelTypeRelationsPrograms</code> instance.
   */
