...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/ContactResult'], factory);
   ...
   * @module radiomanagermodels/ContactResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ContactResults</code>.
   * @alias module:radiomanagermodels/ContactResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ContactResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ContactResults} The populated <code>ContactResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/ContactResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/ContactResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/ContactResult>} results
   */
