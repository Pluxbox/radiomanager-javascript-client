...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ItemRelationsBlock
   * @version 2.0
   */

  /**
   * Constructs a new <code>ItemRelationsBlock</code>.
   * @alias module:radiomanagermodels/ItemRelationsBlock
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ItemRelationsBlock} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ItemRelationsBlock} The populated <code>ItemRelationsBlock</code> instance.
   */
