...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/Program', 'radiomanagermodels/ProgramInputOnly'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Program'), require('./ProgramInputOnly'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.ProgramDataInput = factory(root.radiomanager.ApiClient, root.radiomanager.Program, root.radiomanager.ProgramInputOnly);
  }
}(this, function(ApiClient, Program, ProgramInputOnly) {
  'use strict';
