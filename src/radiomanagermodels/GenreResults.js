...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/GenreResult'], factory);
   ...
   * @module radiomanagermodels/GenreResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>GenreResults</code>.
   * @alias module:radiomanagermodels/GenreResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/GenreResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/GenreResults} The populated <code>GenreResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/GenreResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/GenreResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/GenreResult>} results
   */
