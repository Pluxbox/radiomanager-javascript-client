...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/BlockResult'], factory);
   ...
   * @module radiomanagermodels/BlockResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>BlockResults</code>.
   * @alias module:radiomanagermodels/BlockResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/BlockResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/BlockResults} The populated <code>BlockResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/BlockResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/BlockResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/BlockResult>} results
   */
