...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ContactRelationsItems
   * @version 2.0
   */

  /**
   * Constructs a new <code>ContactRelationsItems</code>.
   * @alias module:radiomanagermodels/ContactRelationsItems
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ContactRelationsItems} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ContactRelationsItems} The populated <code>ContactRelationsItems</code> instance.
   */
