...
(function(root, factory) {
   ...
   * @module radiomanagermodels/TagOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>TagOutputOnly</code>.
   * @alias module:radiomanagermodels/TagOutputOnly
   * @class
   * @param id {Number} 
   */
   ...
   * @param {module:radiomanagermodels/TagOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanagermodels/TagOutputOnly} The populated <code>TagOutputOnly</code> instance.
   */
