...
(function(root, factory) {
   ...
   * @module radiomanagermodels/BroadcastOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastOutputOnly</code>.
   * @alias module:radiomanagermodels/BroadcastOutputOnly
   * @class
   * @param id {Number} 
   ...
   * @param {module:radiomanagermodels/BroadcastOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanagermodels/BroadcastOutputOnly} The populated <code>BroadcastOutputOnly</code> instance.
   */
