...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ItemRelationsCampaign
   * @version 2.0
   */

  /**
   * Constructs a new <code>ItemRelationsCampaign</code>.
   * @alias module:radiomanagermodels/ItemRelationsCampaign
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ItemRelationsCampaign} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ItemRelationsCampaign} The populated <code>ItemRelationsCampaign</code> instance.
   */
