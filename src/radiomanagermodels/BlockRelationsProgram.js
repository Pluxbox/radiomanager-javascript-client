...
(function(root, factory) {
   ...
   * @module radiomanagermodels/BlockRelationsProgram
   * @version 2.0
   */

  /**
   * Constructs a new <code>BlockRelationsProgram</code>.
   * @alias module:radiomanagermodels/BlockRelationsProgram
   * @class
   */
   ...
   * @param {module:radiomanagermodels/BlockRelationsProgram} obj Optional instance to populate.
   * @return {module:radiomanagermodels/BlockRelationsProgram} The populated <code>BlockRelationsProgram</code> instance.
   */
