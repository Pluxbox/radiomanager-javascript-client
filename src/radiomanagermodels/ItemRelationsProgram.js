...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ItemRelationsProgram
   * @version 2.0
   */

  /**
   * Constructs a new <code>ItemRelationsProgram</code>.
   * @alias module:radiomanagermodels/ItemRelationsProgram
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ItemRelationsProgram} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ItemRelationsProgram} The populated <code>ItemRelationsProgram</code> instance.
   */
