...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/BroadcastRelationsModelType', 'radiomanagermodels/PresenterRelationsBroadcasts', 'radiomanagermodels/PresenterRelationsPrograms'], factory);
   ...
   * @module radiomanagermodels/PresenterRelations
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterRelations</code>.
   * @alias module:radiomanagermodels/PresenterRelations
   * @class
   */
   ...
   * @param {module:radiomanagermodels/PresenterRelations} obj Optional instance to populate.
   * @return {module:radiomanagermodels/PresenterRelations} The populated <code>PresenterRelations</code> instance.
   */
  ...
  /**
   * @return {module:radiomanagermodels/PresenterRelationsPrograms}
   */
  ...
  /**
   * @param {module:radiomanagermodels/PresenterRelationsPrograms} programs
   */
  ...
  /**
   * @return {module:radiomanagermodels/PresenterRelationsBroadcasts}
   */
  ...
  /**
   * @param {module:radiomanagermodels/PresenterRelationsBroadcasts} broadcasts
   */
