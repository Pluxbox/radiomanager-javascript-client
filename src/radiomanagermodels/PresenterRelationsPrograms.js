...
(function(root, factory) {
   ...
   * @module radiomanagermodels/PresenterRelationsPrograms
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterRelationsPrograms</code>.
   * @alias module:radiomanagermodels/PresenterRelationsPrograms
   * @class
   */
   ...
   * @param {module:radiomanagermodels/PresenterRelationsPrograms} obj Optional instance to populate.
   * @return {module:radiomanagermodels/PresenterRelationsPrograms} The populated <code>PresenterRelationsPrograms</code> instance.
   */
