...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ContactOutputOnly
   * @version 2.0
   */
   ...
   * Contact
   * @alias module:radiomanagermodels/ContactOutputOnly
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ContactOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ContactOutputOnly} The populated <code>ContactOutputOnly</code> instance.
   */
