...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ProgramRelationsPresenters
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramRelationsPresenters</code>.
   * @alias module:radiomanagermodels/ProgramRelationsPresenters
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ProgramRelationsPresenters} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ProgramRelationsPresenters} The populated <code>ProgramRelationsPresenters</code> instance.
   */
