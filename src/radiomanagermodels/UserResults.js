...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/UserResult'], factory);
   ...
   * @module radiomanagermodels/UserResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>UserResults</code>.
   * @alias module:radiomanagermodels/UserResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/UserResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/UserResults} The populated <code>UserResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/UserResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/UserResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/UserResult>} results
   */
