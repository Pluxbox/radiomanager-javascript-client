...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ModelTypeRelationsCampaigns
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeRelationsCampaigns</code>.
   * @alias module:radiomanagermodels/ModelTypeRelationsCampaigns
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ModelTypeRelationsCampaigns} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ModelTypeRelationsCampaigns} The populated <code>ModelTypeRelationsCampaigns</code> instance.
   */
