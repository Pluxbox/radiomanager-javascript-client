...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ProgramRelationsItems
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramRelationsItems</code>.
   * @alias module:radiomanagermodels/ProgramRelationsItems
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ProgramRelationsItems} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ProgramRelationsItems} The populated <code>ProgramRelationsItems</code> instance.
   */
