...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ModelTypeRelationsPresenters
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeRelationsPresenters</code>.
   * @alias module:radiomanagermodels/ModelTypeRelationsPresenters
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ModelTypeRelationsPresenters} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ModelTypeRelationsPresenters} The populated <code>ModelTypeRelationsPresenters</code> instance.
   */
