...
(function(root, factory) {
   ...
   * @module radiomanagermodels/Forbidden
   * @version 2.0
   */

  /**
   * Constructs a new <code>Forbidden</code>.
   * @alias module:radiomanagermodels/Forbidden
   * @class
   ...
   * @param {module:radiomanagermodels/Forbidden} obj Optional instance to populate.
   * @return {module:radiomanagermodels/Forbidden} The populated <code>Forbidden</code> instance.
   */
