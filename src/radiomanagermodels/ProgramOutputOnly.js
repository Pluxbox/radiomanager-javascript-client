...
(function(root, factory) {
   ...
   * @module radiomanagermodels/ProgramOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramOutputOnly</code>.
   * @alias module:radiomanagermodels/ProgramOutputOnly
   * @class
   * @param id {Number} 
   ...
   * @param {module:radiomanagermodels/ProgramOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ProgramOutputOnly} The populated <code>ProgramOutputOnly</code> instance.
   */
