...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/ProgramResult'], factory);
   ...
   * @module radiomanagermodels/ProgramResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramResults</code>.
   * @alias module:radiomanagermodels/ProgramResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ProgramResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ProgramResults} The populated <code>ProgramResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/ProgramResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/ProgramResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/ProgramResult>} results
   */
