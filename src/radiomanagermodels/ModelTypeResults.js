...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/ModelTypeResult'], factory);
   ...
   * @module radiomanagermodels/ModelTypeResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeResults</code>.
   * @alias module:radiomanagermodels/ModelTypeResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ModelTypeResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ModelTypeResults} The populated <code>ModelTypeResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/ModelTypeResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/ModelTypeResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/ModelTypeResult>} results
   */
