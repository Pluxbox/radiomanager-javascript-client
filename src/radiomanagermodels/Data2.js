...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.radiomanager.Data2 = factory(root.radiomanager.ApiClient, root.radiomanager.ImportItem);
  }
   ...
   * @module radiomanagermodels/Data2
   * @version 2.0
   */

  /**
   * Constructs a new <code>Data2</code>.
   * @alias module:radiomanagermodels/Data2
   * @class
   */
   ...
   * @param {module:radiomanagermodels/Data2} obj Optional instance to populate.
   * @return {module:radiomanagermodels/Data2} The populated <code>Data2</code> instance.
   */
