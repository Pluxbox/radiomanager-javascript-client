...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/ItemResult'], factory);
   ...
   * @module radiomanagermodels/ItemResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ItemResults</code>.
   * @alias module:radiomanagermodels/ItemResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/ItemResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/ItemResults} The populated <code>ItemResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/ItemResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/ItemResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/ItemResult>} results
   */
