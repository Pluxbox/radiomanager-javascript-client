...
(function(root, factory) {
   ...
   * @module radiomanagermodels/Data
   * @version 2.0
   */

  /**
   * Constructs a new <code>Data</code>.
   * @alias module:radiomanagermodels/Data
   * @class
   */
   ...
   * @param {module:radiomanagermodels/Data} obj Optional instance to populate.
   * @return {module:radiomanagermodels/Data} The populated <code>Data</code> instance.
   */
