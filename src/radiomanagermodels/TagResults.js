...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/TagResult'], factory);
   ...
   * @module radiomanagermodels/TagResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>TagResults</code>.
   * @alias module:radiomanagermodels/TagResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/TagResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/TagResults} The populated <code>TagResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/TagResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/TagResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/TagResult>} results
   */
