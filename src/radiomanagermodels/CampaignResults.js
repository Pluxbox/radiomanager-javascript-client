...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/CampaignResult'], factory);
   ...
   * @module radiomanagermodels/CampaignResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>CampaignResults</code>.
   * @alias module:radiomanagermodels/CampaignResults
   * @class
   */
   ...
   * @param {module:radiomanagermodels/CampaignResults} obj Optional instance to populate.
   * @return {module:radiomanagermodels/CampaignResults} The populated <code>CampaignResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanagermodels/CampaignResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanagermodels/CampaignResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanagermodels/CampaignResult>} results
   */
