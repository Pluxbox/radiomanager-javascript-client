...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'radiomanagermodels/Forbidden', 'radiomanagermodels/ModelTypeResult', 'radiomanagermodels/ModelTypeResults', 'radiomanagermodels/NotFound', 'radiomanagermodels/TooManyRequests'], factory);
  ...
  /**
   * ModelType service.
   * @module radiomanagerclient/ModelTypeApi
   * @version 2.0
   */

  /**
   * Constructs a new ModelTypeApi. 
   * @alias module:radiomanagerclient/ModelTypeApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanagermodels/ModelTypeResult} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanagermodels/ModelTypeResult}
     */
