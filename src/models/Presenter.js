 ...
 * @module models/Presenter
 * @version 2.0
 */
class Presenter {
    /**
     * Constructs a new <code>Presenter</code>.
     * @alias module:models/Presenter
     ...
     * @param {module:models/Presenter} obj Optional instance to populate.
     * @return {module:models/Presenter} The populated <code>Presenter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Presenter();
    ...
    /**
     * Validates the JSON data with respect to <code>Presenter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Presenter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of Presenter.RequiredProperties) {
            if (!data[property]) {
...
Presenter.RequiredProperties = ["model_type_id"];
