...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/TagResult'], factory);
   ...
   * @module models/TagResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>TagResults</code>.
   * @alias module:models/TagResults
   * @class
   */
   ...
   * @param {module:models/TagResults} obj Optional instance to populate.
   * @return {module:models/TagResults} The populated <code>TagResults</code> instance.
   */
