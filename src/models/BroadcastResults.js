...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/BroadcastResult'], factory);
   ...
   * @module models/BroadcastResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastResults</code>.
   * @alias module:models/BroadcastResults
   * @class
   */
   ...
   * @param {module:models/BroadcastResults} obj Optional instance to populate.
   * @return {module:models/BroadcastResults} The populated <code>BroadcastResults</code> instance.
   */
