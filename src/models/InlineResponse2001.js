...
class InlineResponse2001 {
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse2001</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse2001</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                BroadcastResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/BroadcastResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/BroadcastResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse2001.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse2001.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse2001.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse2001.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse2001.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse2001.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse2001.prototype['prev_page_url'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse2001.prototype['to'] = undefined;
...
/**
 * @member {Array.<module:models/BroadcastResult>} results
 */
