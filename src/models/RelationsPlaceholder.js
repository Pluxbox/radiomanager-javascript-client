...
(function(root, factory) {
   ...
   * @module models/RelationsPlaceholder
   * @version 2.0
   */

  /**
   * Constructs a new <code>RelationsPlaceholder</code>.
   * @alias module:models/RelationsPlaceholder
   * @class
   ...
   * @param {module:models/RelationsPlaceholder} obj Optional instance to populate.
   * @return {module:models/RelationsPlaceholder} The populated <code>RelationsPlaceholder</code> instance.
   */
