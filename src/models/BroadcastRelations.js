...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/BlockRelationsProgram', 'models/BroadcastRelationsBlocks', 'models/BroadcastRelationsGenre', 'models/BroadcastRelationsItems', 'models/BroadcastRelationsModelType', 'models/BroadcastRelationsPresenters', 'models/BroadcastRelationsTags'], factory);
