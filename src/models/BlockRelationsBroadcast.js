...
class BlockRelationsBroadcast {
    ...
    constructor() { 
        ...
        BlockRelationsBroadcast.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BlockRelationsBroadcast();
    ...
    /**
     * Validates the JSON data with respect to <code>BlockRelationsBroadcast</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockRelationsBroadcast</code>.
     */
 ...
 * @member {String} href
 */
BlockRelationsBroadcast.prototype['href'] = undefined;

/**
 * @member {String} model
 */
BlockRelationsBroadcast.prototype['model'] = undefined;

/**
 * @member {String} operation
 */
BlockRelationsBroadcast.prototype['operation'] = undefined;

/**
 * @member {module:models/BlockRelationsBroadcastParams} params
 */
BlockRelationsBroadcast.prototype['params'] = undefined;
...
export default BlockRelationsBroadcast;
