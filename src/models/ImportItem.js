...
import ImportItemAllOf from './ImportItemAllOf';
...
class ImportItem {
    ...
    constructor(modelTypeId, externalId) { 
        ...
        ImportItem.initialize(this, modelTypeId, externalId);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportItem.RequiredProperties) {
            if (!data[property]) {
...
ImportItem.RequiredProperties = ["model_type_id", "external_id"];

/**
 * @member {Number} model_type_id
 */
ImportItem.prototype['model_type_id'] = undefined;

/**
 * @member {String} external_id
 */
ImportItem.prototype['external_id'] = undefined;

/**
 * @member {Object} field_values
 */
ImportItem.prototype['field_values'] = undefined;

/**
 * @member {String} title
 */
ImportItem.prototype['title'] = undefined;

/**
 * @member {Number} duration
 */
ImportItem.prototype['duration'] = undefined;

/**
 * @member {Date} start
 */
ImportItem.prototype['start'] = undefined;

/**
 * @member {Boolean} recommended
 */
ImportItem.prototype['recommended'] = undefined;

/**
 * @member {Boolean} static_start
 */
ImportItem.prototype['static_start'] = undefined;

/**
 * @member {String} details
 */
ImportItem.prototype['details'] = undefined;

/**
 * @member {Array.<Number>} contacts
 */
ImportItem.prototype['contacts'] = undefined;

/**
 * @member {Array.<Number>} tags
 */
ImportItem.prototype['tags'] = undefined;

/**
 * @member {Number} broadcast_id
 */
ImportItem.prototype['broadcast_id'] = undefined;
