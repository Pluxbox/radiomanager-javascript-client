...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/ContactResult'], factory);
   ...
   * @module models/ContactResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ContactResults</code>.
   * @alias module:models/ContactResults
   * @class
   */
   ...
   * @param {module:models/ContactResults} obj Optional instance to populate.
   * @return {module:models/ContactResults} The populated <code>ContactResults</code> instance.
   */
