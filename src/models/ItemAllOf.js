...
/**
 * The ItemAllOf model module.
 * @module models/ItemAllOf
 * @version 2.0
 */
class ItemAllOf {
    /**
     * Constructs a new <code>ItemAllOf</code>.
     * @alias module:models/ItemAllOf
    ...
    /**
     * Constructs a <code>ItemAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:models/ItemAllOf} obj Optional instance to populate.
     * @return {module:models/ItemAllOf} The populated <code>ItemAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>ItemAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ItemAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ItemAllOf.RequiredProperties) {
            if (!data[property]) {
...
/**
     * @return {module:models/ItemAllOf.StatusEnum}
     */
    getStatus() {
        return this.status;
    }
    ...
    /**
     * @param {module:models/ItemAllOf.StatusEnum} status
     */
    setStatus(status) {
        this['status'] = status;
    }
...
ItemAllOf.RequiredProperties = ["model_type_id"];
