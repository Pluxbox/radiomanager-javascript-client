 ...
 * @module models/InlineResponse2004
 * @version 2.0
 */
class InlineResponse2004 {
    /**
     * Constructs a new <code>InlineResponse2004</code>.
     * @alias module:models/InlineResponse2004
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse2004} obj Optional instance to populate.
     * @return {module:models/InlineResponse2004} The populated <code>InlineResponse2004</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse2004</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse2004</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                CampaignResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/CampaignResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/CampaignResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse2004.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse2004.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse2004.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse2004.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse2004.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse2004.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse2004.prototype['prev_page_url'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse2004.prototype['to'] = undefined;
...
/**
 * @member {Array.<module:models/CampaignResult>} results
 */
