...
(function(root, factory) {
   ...
   * Story
   * @alias module:models/StoryOutputOnly
   * @class
   */
   ...
   * @param {module:models/StoryOutputOnly} obj Optional instance to populate.
   * @return {module:models/StoryOutputOnly} The populated <code>StoryOutputOnly</code> instance.
   */
