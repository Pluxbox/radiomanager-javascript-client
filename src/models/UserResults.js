...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/UserResult'], factory);
   ...
   * @module models/UserResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>UserResults</code>.
   * @alias module:models/UserResults
   * @class
   */
   ...
   * @param {module:models/UserResults} obj Optional instance to populate.
   * @return {module:models/UserResults} The populated <code>UserResults</code> instance.
   */
