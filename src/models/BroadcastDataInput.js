...
import BroadcastInputOnly from './BroadcastInputOnly';
...
class BroadcastDataInput {
     ...
     */
    constructor() { 
        Broadcast.initialize(this);BroadcastInputOnly.initialize(this);
        BroadcastDataInput.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BroadcastDataInput();
    ...
    /**
     * Validates the JSON data with respect to <code>BroadcastDataInput</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BroadcastDataInput</code>.
     */
 ...
 */
BroadcastDataInput.prototype['program_id'] = undefined;

/**
 * @member {Number} model_type_id
 */
BroadcastDataInput.prototype['model_type_id'] = undefined;

/**
 * @member {Number} station_id
 */
BroadcastDataInput.prototype['station_id'] = undefined;

/**
 * @member {Object} field_values
 */
BroadcastDataInput.prototype['field_values'] = undefined;

/**
 * @member {String} title
 */
BroadcastDataInput.prototype['title'] = undefined;

/**
 * @member {Date} start
 */
BroadcastDataInput.prototype['start'] = undefined;

/**
 * @member {Date} stop
 */
BroadcastDataInput.prototype['stop'] = undefined;

/**
 * @member {Number} genre_id
 */
BroadcastDataInput.prototype['genre_id'] = undefined;

/**
 * @member {String} description
 */
BroadcastDataInput.prototype['description'] = undefined;

/**
 * @member {String} short_name
 */
BroadcastDataInput.prototype['short_name'] = undefined;

/**
 * @member {String} medium_name
 */
BroadcastDataInput.prototype['medium_name'] = undefined;

/**
 * @member {String} website
 */
BroadcastDataInput.prototype['website'] = undefined;

/**
 * @member {String} email
 */
BroadcastDataInput.prototype['email'] = undefined;

/**
 * @member {Boolean} recommended
 */
BroadcastDataInput.prototype['recommended'] = undefined;

/**
 * @member {String} language
 */
BroadcastDataInput.prototype['language'] = undefined;

/**
 * @member {Boolean} published
 */
BroadcastDataInput.prototype['published'] = undefined;

/**
 * @member {String} repetition_uid
 */
BroadcastDataInput.prototype['repetition_uid'] = undefined;

/**
 * @member {module:models/BroadcastDataInput.RepetitionTypeEnum} repetition_type
 */
BroadcastDataInput.prototype['repetition_type'] = undefined;

/**
 * @member {Date} repetition_end
 */
BroadcastDataInput.prototype['repetition_end'] = undefined;

/**
 * @member {Date} repetition_start
 */
BroadcastDataInput.prototype['repetition_start'] = undefined;

/**
 * @member {String} repetition_days
 */
BroadcastDataInput.prototype['repetition_days'] = undefined;

/**
 * @member {Number} pty_code_id
 */
BroadcastDataInput.prototype['pty_code_id'] = undefined;

/**
 * @member {Number} planned_in_epg
 */
BroadcastDataInput.prototype['planned_in_epg'] = undefined;

/**
 * @member {Number} group_id
 */
BroadcastDataInput.prototype['group_id'] = undefined;

/**
 * @member {Array.<Number>} tags
 */
BroadcastDataInput.prototype['tags'] = undefined;

/**
 * @member {Array.<Number>} presenters
 */
BroadcastDataInput.prototype['presenters'] = undefined;
 ...
 * @readonly
 */
BroadcastDataInput['RepetitionTypeEnum'] = {
...
export default BroadcastDataInput;
