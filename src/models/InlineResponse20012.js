 ...
 * @module models/InlineResponse20012
 * @version 2.0
 */
class InlineResponse20012 {
    /**
     * Constructs a new <code>InlineResponse20012</code>.
     * @alias module:models/InlineResponse20012
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse20012} obj Optional instance to populate.
     * @return {module:models/InlineResponse20012} The populated <code>InlineResponse20012</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse20012</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse20012</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                TagResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/TagResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/TagResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse20012.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse20012.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse20012.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse20012.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse20012.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse20012.prototype['per_page'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse20012.prototype['to'] = undefined;

/**
 * @member {Number} total
 */
InlineResponse20012.prototype['total'] = undefined;

/**
 * @member {Array.<module:models/TagResult>} results
 */
