...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/BlockResult'], factory);
   ...
   * @module models/BlockResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>BlockResults</code>.
   * @alias module:models/BlockResults
   * @class
   */
   ...
   * @param {module:models/BlockResults} obj Optional instance to populate.
   * @return {module:models/BlockResults} The populated <code>BlockResults</code> instance.
   */
