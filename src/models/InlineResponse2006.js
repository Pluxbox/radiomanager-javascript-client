 ...
 * @module models/InlineResponse2006
 * @version 2.0
 */
class InlineResponse2006 {
    /**
     * Constructs a new <code>InlineResponse2006</code>.
     * @alias module:models/InlineResponse2006
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse2006} obj Optional instance to populate.
     * @return {module:models/InlineResponse2006} The populated <code>InlineResponse2006</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse2006</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse2006</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                GenreResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/GenreResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/GenreResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse2006.prototype['current_page'] = undefined;
 ...
 */
InlineResponse2006.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse2006.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse2006.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse2006.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse2006.prototype['prev_page_url'] = undefined;
 ...
 * @member {Number} total
 */
InlineResponse2006.prototype['total'] = undefined;

/**
 * @member {Array.<module:models/GenreResult>} results
 */
