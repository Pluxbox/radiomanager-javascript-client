...
(function(root, factory) {
   ...
   * @module models/UnprocessableEntity
   * @version 2.0
   */

  /**
   * Constructs a new <code>UnprocessableEntity</code>.
   * @alias module:models/UnprocessableEntity
   * @class
   ...
   * @param {module:models/UnprocessableEntity} obj Optional instance to populate.
   * @return {module:models/UnprocessableEntity} The populated <code>UnprocessableEntity</code> instance.
   */
