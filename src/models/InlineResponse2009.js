...
import ModelTypeResult from './ModelTypeResult';

/**
 * The InlineResponse2009 model module.
 * @module models/InlineResponse2009
 * @version 2.0
 */
class InlineResponse2009 {
    /**
     * Constructs a new <code>InlineResponse2009</code>.
     * @alias module:models/InlineResponse2009
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse2009} obj Optional instance to populate.
     * @return {module:models/InlineResponse2009} The populated <code>InlineResponse2009</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse2009</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse2009</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ModelTypeResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/ModelTypeResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/ModelTypeResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse2009.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse2009.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse2009.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse2009.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse2009.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse2009.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse2009.prototype['prev_page_url'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse2009.prototype['to'] = undefined;
...
/**
 * @member {Array.<module:models/ModelTypeResult>} results
 */
