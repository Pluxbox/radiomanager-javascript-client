...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/ProgramResult'], factory);
   ...
   * @module models/ProgramResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramResults</code>.
   * @alias module:models/ProgramResults
   * @class
   */
   ...
   * @param {module:models/ProgramResults} obj Optional instance to populate.
   * @return {module:models/ProgramResults} The populated <code>ProgramResults</code> instance.
   */
