...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/GenreResult'], factory);
   ...
   * @module models/GenreResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>GenreResults</code>.
   * @alias module:models/GenreResults
   * @class
   */
   ...
   * @param {module:models/GenreResults} obj Optional instance to populate.
   * @return {module:models/GenreResults} The populated <code>GenreResults</code> instance.
   */
