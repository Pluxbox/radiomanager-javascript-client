...
(function(root, factory) {
   ...
   * @param {module:models/Forbidden} obj Optional instance to populate.
   * @return {module:models/Forbidden} The populated <code>Forbidden</code> instance.
   */
