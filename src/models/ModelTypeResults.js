...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/ModelTypeResult'], factory);
   ...
   * @module models/ModelTypeResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeResults</code>.
   * @alias module:models/ModelTypeResults
   * @class
   */
   ...
   * @param {module:models/ModelTypeResults} obj Optional instance to populate.
   * @return {module:models/ModelTypeResults} The populated <code>ModelTypeResults</code> instance.
   */
