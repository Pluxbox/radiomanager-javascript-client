...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/StoryResult'], factory);
   ...
   * @module models/StoryResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>StoryResults</code>.
   * @alias module:models/StoryResults
   * @class
   */
   ...
   * @param {module:models/StoryResults} obj Optional instance to populate.
   * @return {module:models/StoryResults} The populated <code>StoryResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:models/StoryResult>} results
   */
  ...
  /**
   * @return {Array.<module:models/StoryResult>}
   */
  ...
  /**
   * @param {Array.<module:models/StoryResult>} results
   */
