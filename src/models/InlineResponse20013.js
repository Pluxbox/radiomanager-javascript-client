 ...
 * @module models/InlineResponse20013
 * @version 2.0
 */
class InlineResponse20013 {
    /**
     * Constructs a new <code>InlineResponse20013</code>.
     * @alias module:models/InlineResponse20013
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse20013} obj Optional instance to populate.
     * @return {module:models/InlineResponse20013} The populated <code>InlineResponse20013</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [UserResult]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse20013</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse20013</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                UserResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/UserResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/UserResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse20013.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse20013.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse20013.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse20013.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse20013.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse20013.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse20013.prototype['prev_page_url'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse20013.prototype['to'] = undefined;

/**
 * @member {Number} total
 */
InlineResponse20013.prototype['total'] = undefined;

/**
 * @member {Array.<module:models/UserResult>} results
 */
