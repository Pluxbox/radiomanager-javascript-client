 ...
 * @module models/InlineResponse20011
 * @version 2.0
 */
class InlineResponse20011 {
    /**
     * Constructs a new <code>InlineResponse20011</code>.
     * @alias module:models/InlineResponse20011
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse20011} obj Optional instance to populate.
     * @return {module:models/InlineResponse20011} The populated <code>InlineResponse20011</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse20011</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse20011</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ProgramResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/ProgramResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/ProgramResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse20011.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse20011.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse20011.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse20011.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse20011.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse20011.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse20011.prototype['prev_page_url'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse20011.prototype['to'] = undefined;
...
/**
 * @member {Array.<module:models/ProgramResult>} results
 */
