...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/CampaignResult'], factory);
   ...
   * @module models/CampaignResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>CampaignResults</code>.
   * @alias module:models/CampaignResults
   * @class
   */
   ...
   * @param {module:models/CampaignResults} obj Optional instance to populate.
   * @return {module:models/CampaignResults} The populated <code>CampaignResults</code> instance.
   */
