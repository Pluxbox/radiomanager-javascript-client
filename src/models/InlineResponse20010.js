...
import PresenterResult from './PresenterResult';

/**
 * The InlineResponse20010 model module.
 * @module models/InlineResponse20010
 * @version 2.0
 */
class InlineResponse20010 {
    /**
     * Constructs a new <code>InlineResponse20010</code>.
     * @alias module:models/InlineResponse20010
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse20010} obj Optional instance to populate.
     * @return {module:models/InlineResponse20010} The populated <code>InlineResponse20010</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [PresenterResult]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse20010</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse20010</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                PresenterResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/PresenterResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/PresenterResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse20010.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse20010.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse20010.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse20010.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse20010.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse20010.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse20010.prototype['prev_page_url'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse20010.prototype['to'] = undefined;

/**
 * @member {Number} total
 */
InlineResponse20010.prototype['total'] = undefined;

/**
 * @member {Array.<module:models/PresenterResult>} results
 */
