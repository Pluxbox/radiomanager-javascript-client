 ...
 * @module models/InlineResponse2005
 * @version 2.0
 */
class InlineResponse2005 {
    /**
     * Constructs a new <code>InlineResponse2005</code>.
     * @alias module:models/InlineResponse2005
     */
    constructor() { 
     ...
     * @param {module:models/InlineResponse2005} obj Optional instance to populate.
     * @return {module:models/InlineResponse2005} The populated <code>InlineResponse2005</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [ContactResult]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineResponse2005</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineResponse2005</code>.
     */
    static validateJSON(data) {
        ...
        if (data['results']) { // data not null
            ...
            for (const item of data['results']) {
                ContactResult.validateJsonObject(item);
            };
        }
...
/**
     * @return {Array.<module:models/ContactResult>}
     */
    getResults() {
        return this.results;
    }
    ...
    /**
     * @param {Array.<module:models/ContactResult>} results
     */
    setResults(results) {
 ...
 */
InlineResponse2005.prototype['current_page'] = undefined;

/**
 * @member {Number} from
 */
InlineResponse2005.prototype['from'] = undefined;

/**
 * @member {Number} last_page
 */
InlineResponse2005.prototype['last_page'] = undefined;

/**
 * @member {String} next_page_url
 */
InlineResponse2005.prototype['next_page_url'] = undefined;

/**
 * @member {String} path
 */
InlineResponse2005.prototype['path'] = undefined;

/**
 * @member {Number} per_page
 */
InlineResponse2005.prototype['per_page'] = undefined;

/**
 * @member {String} prev_page_url
 */
InlineResponse2005.prototype['prev_page_url'] = undefined;

/**
 * @member {Number} to
 */
InlineResponse2005.prototype['to'] = undefined;

/**
 * @member {Number} total
 */
InlineResponse2005.prototype['total'] = undefined;

/**
 * @member {Array.<module:models/ContactResult>} results
 */
