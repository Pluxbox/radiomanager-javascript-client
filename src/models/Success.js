...
(function(root, factory) {
   ...
   * @module models/Success
   * @version 2.0
   */

  /**
   * Constructs a new <code>Success</code>.
   * @alias module:models/Success
   * @class
   ...
   * @param {module:models/Success} obj Optional instance to populate.
   * @return {module:models/Success} The populated <code>Success</code> instance.
   */
