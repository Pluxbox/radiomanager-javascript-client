...
(function(root, factory) {
   ...
   * @module models/ReadOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>ReadOnly</code>.
   * @alias module:models/ReadOnly
   * @class
   ...
   * @param {module:models/ReadOnly} obj Optional instance to populate.
   * @return {module:models/ReadOnly} The populated <code>ReadOnly</code> instance.
   */
