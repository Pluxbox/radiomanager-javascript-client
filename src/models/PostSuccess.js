...
(function(root, factory) {
   ...
   * @module models/PostSuccess
   * @version 2.0
   */

  /**
   * Constructs a new <code>PostSuccess</code>.
   * @alias module:models/PostSuccess
   * @class
   ...
   * @param {module:models/PostSuccess} obj Optional instance to populate.
   * @return {module:models/PostSuccess} The populated <code>PostSuccess</code> instance.
   */
