...
(function(root, factory) {
   ...
   * @module models/NotFound
   * @version 2.0
   */

  /**
   * Constructs a new <code>NotFound</code>.
   * @alias module:models/NotFound
   * @class
   ...
   * @param {module:models/NotFound} obj Optional instance to populate.
   * @return {module:models/NotFound} The populated <code>NotFound</code> instance.
   */
