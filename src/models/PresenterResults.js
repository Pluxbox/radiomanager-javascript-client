...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/PresenterResult'], factory);
   ...
   * @module models/PresenterResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterResults</code>.
   * @alias module:models/PresenterResults
   * @class
   */
   ...
   * @param {module:models/PresenterResults} obj Optional instance to populate.
   * @return {module:models/PresenterResults} The populated <code>PresenterResults</code> instance.
   */
