...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/ItemResult'], factory);
   ...
   * @module models/ItemResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ItemResults</code>.
   * @alias module:models/ItemResults
   * @class
   */
   ...
   * @param {module:models/ItemResults} obj Optional instance to populate.
   * @return {module:models/ItemResults} The populated <code>ItemResults</code> instance.
   */
