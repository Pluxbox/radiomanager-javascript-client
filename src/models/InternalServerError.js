...
(function(root, factory) {
   ...
   * @module models/InternalServerError
   * @version 2.0
   */

  /**
   * Constructs a new <code>InternalServerError</code>.
   * @alias module:models/InternalServerError
   * @class
   ...
   * @param {module:models/InternalServerError} obj Optional instance to populate.
   * @return {module:models/InternalServerError} The populated <code>InternalServerError</code> instance.
   */
