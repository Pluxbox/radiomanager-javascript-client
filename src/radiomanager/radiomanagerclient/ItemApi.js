...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Data', 'radiomanager/radiomanagermodels/Data1', 'radiomanager/radiomanagermodels/Forbidden', 'radiomanager/radiomanagermodels/ImportItem', 'radiomanager/radiomanagermodels/InlineResponse202', 'radiomanager/radiomanagermodels/Item', 'radiomanager/radiomanagermodels/ItemDataInput', 'radiomanager/radiomanagermodels/ItemResult', 'radiomanager/radiomanagermodels/ItemResults', 'radiomanager/radiomanagermodels/NotFound', 'radiomanager/radiomanagermodels/PostSuccess', 'radiomanager/radiomanagermodels/Success', 'radiomanager/radiomanagermodels/TooManyRequests', 'radiomanager/radiomanagermodels/UnprocessableEntity'], factory);
  ...
  /**
   * Item service.
   * @module radiomanager/radiomanagerclient/ItemApi
   * @version 2.0
   */

  /**
   * Constructs a new ItemApi. 
   * @alias module:radiomanager/radiomanagerclient/ItemApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:radiomanager/radiomanagermodels/ItemDataInput} opts.data Data *(Optional)*
     ...
     * Post a current playing item, keep structure
     * @param {Object} opts Optional parameters
     * @param {module:radiomanager/radiomanagermodels/ImportItem} opts.data Data *(Optional)*
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/ItemResult} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/ItemResult}
     */
     ...
     * @param {module:radiomanager/radiomanagermodels/String} opts.orderDirection Direction of ordering *(Optional)*
     ...
     * @param {module:radiomanager/radiomanagermodels/String} opts.status Play Status of item *(Optional)*
     ...
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/ItemResults} and HTTP response
     */
     ...
     * @param {Number} opts.tagId Search on Tag ID *(Optional)* &#x60;(Relation)&#x60;
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/ItemResults}
     */
     ...
     * Post a playlist, keep current structure
     * @param {Object} opts Optional parameters
     * @param {module:radiomanager/radiomanagermodels/Data1} opts.data Data *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/InlineResponse202} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:radiomanager/radiomanagermodels/Data1} opts.data Data *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/InlineResponse202}
     */
     ...
     * Post a playlist
     * @param {Object} opts Optional parameters
     * @param {module:radiomanager/radiomanagermodels/Data} opts.data Data *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/InlineResponse202} and HTTP response
     */
     ...
     * @param {Number} id ID of Item **(Required)**
     * @param {Object} opts Optional parameters
     * @param {module:radiomanager/radiomanagermodels/Item} opts.data Data *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/Success} and HTTP response
     */
