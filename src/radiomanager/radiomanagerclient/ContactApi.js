...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/ContactDataInput', 'radiomanager/radiomanagermodels/ContactResult', 'radiomanager/radiomanagermodels/ContactResults', 'radiomanager/radiomanagermodels/Forbidden', 'radiomanager/radiomanagermodels/NotFound', 'radiomanager/radiomanagermodels/PostSuccess', 'radiomanager/radiomanagermodels/Success', 'radiomanager/radiomanagermodels/TooManyRequests', 'radiomanager/radiomanagermodels/UnprocessableEntity'], factory);
  ...
  /**
   * Contact service.
   * @module radiomanager/radiomanagerclient/ContactApi
   * @version 2.0
   */

  /**
   * Constructs a new ContactApi. 
   * @alias module:radiomanager/radiomanagerclient/ContactApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * Create contact.
     * Create contact.
     * @param {module:radiomanager/radiomanagermodels/ContactDataInput} data Data **(Required)**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/ContactResult} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/ContactResult}
     */
     ...
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/ContactResults} and HTTP response
     */
     ...
     * @param {Number} opts.itemId Search on Item ID *(Optional)* &#x60;(Relation)&#x60;
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/ContactResults}
     */
     ...
     * @param {Number} id ID of Contact **(Required)**
     * @param {Object} opts Optional parameters
     * @param {module:radiomanager/radiomanagermodels/ContactDataInput} opts.data Data *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/Success} and HTTP response
     */
