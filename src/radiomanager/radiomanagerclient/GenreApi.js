...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Forbidden', 'radiomanager/radiomanagermodels/GenreResult', 'radiomanager/radiomanagermodels/GenreResults', 'radiomanager/radiomanagermodels/NotFound', 'radiomanager/radiomanagermodels/TooManyRequests'], factory);
  ...
  /**
   * Genre service.
   * @module radiomanager/radiomanagerclient/GenreApi
   * @version 2.0
   */

  /**
   * Constructs a new GenreApi. 
   * @alias module:radiomanager/radiomanagerclient/GenreApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/GenreResult} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/GenreResult}
     */
     ...
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/GenreResults} and HTTP response
     */
     ...
     * @param {Number} opts.broadcastId Search on Broadcast ID *(Optional)* &#x60;(Relation)&#x60;
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/GenreResults}
     */
