...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Forbidden', 'radiomanager/radiomanagermodels/NotFound', 'radiomanager/radiomanagermodels/PostSuccess', 'radiomanager/radiomanagermodels/Success', 'radiomanager/radiomanagermodels/TagDataInput', 'radiomanager/radiomanagermodels/TagResult', 'radiomanager/radiomanagermodels/TagResults', 'radiomanager/radiomanagermodels/TooManyRequests', 'radiomanager/radiomanagermodels/UnprocessableEntity'], factory);
  ...
  /**
   * Tag service.
   * @module radiomanager/radiomanagerclient/TagApi
   * @version 2.0
   */

  /**
   * Constructs a new TagApi. 
   * @alias module:radiomanager/radiomanagerclient/TagApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * Create tag.
     * Create tag.
     * @param {module:radiomanager/radiomanagermodels/TagDataInput} data Data **(Required)**
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/TagResult} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/TagResult}
     */
     ...
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/TagResults} and HTTP response
     */
     ...
     * @param {Number} opts.contactId Search on Contact ID *(Optional)* &#x60;(Relation)&#x60;
     * @param {Number} opts.externalStationId Query on a different (content providing) station *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:radiomanager/radiomanagermodels/TagResults}
     */
     ...
     * @param {Number} id ID of Tag **(Required)**
     * @param {Object} opts Optional parameters
     * @param {module:radiomanager/radiomanagermodels/TagDataInput} opts.data Data *(Optional)*
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:radiomanager/radiomanagermodels/Success} and HTTP response
     */
