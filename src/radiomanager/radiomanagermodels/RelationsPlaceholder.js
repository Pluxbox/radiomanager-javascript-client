...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/RelationsPlaceholder
   * @version 2.0
   */

  /**
   * Constructs a new <code>RelationsPlaceholder</code>.
   * @alias module:radiomanager/radiomanagermodels/RelationsPlaceholder
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/RelationsPlaceholder} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/RelationsPlaceholder} The populated <code>RelationsPlaceholder</code> instance.
   */
