...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/BlockRelationsBroadcast', 'radiomanager/radiomanagermodels/BroadcastRelationsModelType', 'radiomanager/radiomanagermodels/ImportItemFieldValues', 'radiomanager/radiomanagermodels/Item', 'radiomanager/radiomanagermodels/ItemOutputOnly', 'radiomanager/radiomanagermodels/ItemRelations', 'radiomanager/radiomanagermodels/ItemRelationsBlock', 'radiomanager/radiomanagermodels/ItemRelationsCampaign', 'radiomanager/radiomanagermodels/ItemRelationsContacts', 'radiomanager/radiomanagermodels/ItemRelationsProgram', 'radiomanager/radiomanagermodels/ItemRelationsTags'], factory);
   ...
   * @module radiomanager/radiomanagermodels/ItemResult
   * @version 2.0
   */

  /**
   * Constructs a new <code>ItemResult</code>.
   * @alias module:radiomanager/radiomanagermodels/ItemResult
   * @class
   * @implements module:radiomanager/radiomanagermodels/ItemOutputOnly
   * @implements module:radiomanager/radiomanagermodels/Item
   * @implements module:radiomanager/radiomanagermodels/ItemRelations
   ...
   * @param {module:radiomanager/radiomanagermodels/ItemResult} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ItemResult} The populated <code>ItemResult</code> instance.
   */
