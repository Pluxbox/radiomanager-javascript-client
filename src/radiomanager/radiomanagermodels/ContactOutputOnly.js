...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.radiomanager.ContactOutputOnly = factory(root.radiomanager.ApiClient);
  }
   ...
   * @module radiomanager/radiomanagermodels/ContactOutputOnly
   * @version 2.0
   */
   ...
   * Contact
   * @alias module:radiomanager/radiomanagermodels/ContactOutputOnly
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ContactOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ContactOutputOnly} The populated <code>ContactOutputOnly</code> instance.
   */
