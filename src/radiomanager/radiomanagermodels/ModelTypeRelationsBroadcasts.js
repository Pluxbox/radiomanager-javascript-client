...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ModelTypeRelationsBroadcasts
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeRelationsBroadcasts</code>.
   * @alias module:radiomanager/radiomanagermodels/ModelTypeRelationsBroadcasts
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ModelTypeRelationsBroadcasts} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ModelTypeRelationsBroadcasts} The populated <code>ModelTypeRelationsBroadcasts</code> instance.
   */
