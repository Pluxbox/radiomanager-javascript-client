...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/NotFound
   * @version 2.0
   */

  /**
   * Constructs a new <code>NotFound</code>.
   * @alias module:radiomanager/radiomanagermodels/NotFound
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/NotFound} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/NotFound} The populated <code>NotFound</code> instance.
   */
