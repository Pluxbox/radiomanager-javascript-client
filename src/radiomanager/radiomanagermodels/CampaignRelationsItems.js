...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/CampaignRelationsItemsParams'], factory);
   ...
   * @module radiomanager/radiomanagermodels/CampaignRelationsItems
   * @version 2.0
   */

  /**
   * Constructs a new <code>CampaignRelationsItems</code>.
   * @alias module:radiomanager/radiomanagermodels/CampaignRelationsItems
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/CampaignRelationsItems} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/CampaignRelationsItems} The populated <code>CampaignRelationsItems</code> instance.
   */
  ...
  /**
   * @member {module:radiomanager/radiomanagermodels/CampaignRelationsItemsParams} params
   */
  ...
  /**
   * @return {module:radiomanager/radiomanagermodels/CampaignRelationsItemsParams}
   */
  ...
  /**
   * @param {module:radiomanager/radiomanagermodels/CampaignRelationsItemsParams} params
   */
