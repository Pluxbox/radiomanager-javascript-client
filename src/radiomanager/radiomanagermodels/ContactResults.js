...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/ContactResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContactResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.ContactResults = factory(root.radiomanager.ApiClient, root.radiomanager.ContactResult);
  }
}(this, function(ApiClient, ContactResult) {
  'use strict';
  ...
  /**
   * The ContactResults model module.
   * @module radiomanager/radiomanagermodels/ContactResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ContactResults</code>.
   * @alias module:radiomanager/radiomanagermodels/ContactResults
   * @class
   */
  ...
  /**
   * Constructs a <code>ContactResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/ContactResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ContactResults} The populated <code>ContactResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/ContactResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/ContactResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/ContactResult>} results
   */
