...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/BroadcastRelationsModelType', 'radiomanager/radiomanagermodels/Contact', 'radiomanager/radiomanagermodels/ContactFieldValues', 'radiomanager/radiomanagermodels/ContactOutputOnly', 'radiomanager/radiomanagermodels/ContactRelations', 'radiomanager/radiomanagermodels/ContactRelationsItems', 'radiomanager/radiomanagermodels/ContactRelationsTags'], factory);
   ...
   * @module radiomanager/radiomanagermodels/ContactResult
   * @version 2.0
   */

  /**
   * Constructs a new <code>ContactResult</code>.
   * @alias module:radiomanager/radiomanagermodels/ContactResult
   * @class
   * @implements module:radiomanager/radiomanagermodels/ContactOutputOnly
   * @implements module:radiomanager/radiomanagermodels/Contact
   * @implements module:radiomanager/radiomanagermodels/ContactRelations
   ...
   * @param {module:radiomanager/radiomanagermodels/ContactResult} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ContactResult} The populated <code>ContactResult</code> instance.
   */
...
exports.prototype['model_type_id'] = undefined;
  ...
  /**
   * @member {module:radiomanager/radiomanagermodels/ContactFieldValues} field_values
   */
