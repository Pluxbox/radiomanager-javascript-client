...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/TooManyRequests
   * @version 2.0
   */

  /**
   * Constructs a new <code>TooManyRequests</code>.
   * @alias module:radiomanager/radiomanagermodels/TooManyRequests
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/TooManyRequests} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/TooManyRequests} The populated <code>TooManyRequests</code> instance.
   */
