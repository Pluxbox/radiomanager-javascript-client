...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/PostSuccess
   * @version 2.0
   */

  /**
   * Constructs a new <code>PostSuccess</code>.
   * @alias module:radiomanager/radiomanagermodels/PostSuccess
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/PostSuccess} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/PostSuccess} The populated <code>PostSuccess</code> instance.
   */
