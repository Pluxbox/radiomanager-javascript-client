...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ProgramRelationsBlocks
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramRelationsBlocks</code>.
   * @alias module:radiomanager/radiomanagermodels/ProgramRelationsBlocks
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ProgramRelationsBlocks} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ProgramRelationsBlocks} The populated <code>ProgramRelationsBlocks</code> instance.
   */
