...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ImportItem
   * @version 2.0
   */

  /**
   * Constructs a new <code>ImportItem</code>.
   * @alias module:radiomanager/radiomanagermodels/ImportItem
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/ImportItem} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ImportItem} The populated <code>ImportItem</code> instance.
   */
