...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Broadcast', 'radiomanager/radiomanagermodels/BroadcastFieldValues', 'radiomanager/radiomanagermodels/BroadcastInputOnly'], factory);
   ...
   * @module radiomanager/radiomanagermodels/BroadcastDataInput
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastDataInput</code>.
   * @alias module:radiomanager/radiomanagermodels/BroadcastDataInput
   * @class
   * @implements module:radiomanager/radiomanagermodels/Broadcast
   * @implements module:radiomanager/radiomanagermodels/BroadcastInputOnly
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/BroadcastDataInput} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BroadcastDataInput} The populated <code>BroadcastDataInput</code> instance.
   */
