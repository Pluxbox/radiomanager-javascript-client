...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/BroadcastResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastResults</code>.
   * @alias module:radiomanager/radiomanagermodels/BroadcastResults
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/BroadcastResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BroadcastResults} The populated <code>BroadcastResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/BroadcastResult>} results
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/BroadcastResult>} results
   */
