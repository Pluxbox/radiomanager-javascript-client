...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ProgramRelationsItemsParams
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramRelationsItemsParams</code>.
   * @alias module:radiomanager/radiomanagermodels/ProgramRelationsItemsParams
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ProgramRelationsItemsParams} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ProgramRelationsItemsParams} The populated <code>ProgramRelationsItemsParams</code> instance.
   */
