...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.radiomanager.BroadcastOutputOnly = factory(root.radiomanager.ApiClient);
  }
   ...
   * @module radiomanager/radiomanagermodels/BroadcastOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastOutputOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/BroadcastOutputOnly
   * @class
   * @param id {Number} 
   ...
   * @param {module:radiomanager/radiomanagermodels/BroadcastOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BroadcastOutputOnly} The populated <code>BroadcastOutputOnly</code> instance.
   */
