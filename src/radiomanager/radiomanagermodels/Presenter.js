...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/Presenter
   * @version 2.0
   */

  /**
   * Constructs a new <code>Presenter</code>.
   * @alias module:radiomanager/radiomanagermodels/Presenter
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/Presenter} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/Presenter} The populated <code>Presenter</code> instance.
   */
