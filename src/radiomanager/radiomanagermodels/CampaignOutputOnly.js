...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Item'], factory);
   ...
   * @module radiomanager/radiomanagermodels/CampaignOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>CampaignOutputOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/CampaignOutputOnly
   * @class
   * @param id {Number} 
   ...
   * @param {module:radiomanager/radiomanagermodels/CampaignOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/CampaignOutputOnly} The populated <code>CampaignOutputOnly</code> instance.
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/Item>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/Item>} item
   */
