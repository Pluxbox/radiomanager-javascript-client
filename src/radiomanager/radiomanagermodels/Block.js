...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/Block
   * @version 2.0
   */

  /**
   * Constructs a new <code>Block</code>.
   * @alias module:radiomanager/radiomanagermodels/Block
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/Block} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/Block} The populated <code>Block</code> instance.
   */
