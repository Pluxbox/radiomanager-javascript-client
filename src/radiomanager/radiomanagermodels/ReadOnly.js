...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.radiomanager.ReadOnly = factory(root.radiomanager.ApiClient);
  }
   ...
   * @module radiomanager/radiomanagermodels/ReadOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>ReadOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/ReadOnly
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/ReadOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ReadOnly} The populated <code>ReadOnly</code> instance.
   */
