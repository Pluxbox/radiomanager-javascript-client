...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ContactRelationsTagsParams
   * @version 2.0
   */

  /**
   * Constructs a new <code>ContactRelationsTagsParams</code>.
   * @alias module:radiomanager/radiomanagermodels/ContactRelationsTagsParams
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ContactRelationsTagsParams} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ContactRelationsTagsParams} The populated <code>ContactRelationsTagsParams</code> instance.
   */
