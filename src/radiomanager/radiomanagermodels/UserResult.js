...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/UserResultSettings'], factory);
   ...
   * @module radiomanager/radiomanagermodels/UserResult
   * @version 2.0
   */

  /**
   * Constructs a new <code>UserResult</code>.
   * @alias module:radiomanager/radiomanagermodels/UserResult
   * @class
   * @param id {Number} 
   * @param email {String} 
   ...
   * @param {module:radiomanager/radiomanagermodels/UserResult} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/UserResult} The populated <code>UserResult</code> instance.
   */
  ...
  /**
   * @member {module:radiomanager/radiomanagermodels/UserResultSettings} settings
   */
  ...
  /**
   * @return {module:radiomanager/radiomanagermodels/UserResultSettings}
   */
  ...
  /**
   * @param {module:radiomanager/radiomanagermodels/UserResultSettings} settings
   */
