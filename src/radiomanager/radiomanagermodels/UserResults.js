...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/UserResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UserResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.UserResults = factory(root.radiomanager.ApiClient, root.radiomanager.UserResult);
  }
}(this, function(ApiClient, UserResult) {
  'use strict';
   ...
   * @module radiomanager/radiomanagermodels/UserResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>UserResults</code>.
   * @alias module:radiomanager/radiomanagermodels/UserResults
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/UserResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/UserResults} The populated <code>UserResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/UserResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/UserResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/UserResult>} results
   */
