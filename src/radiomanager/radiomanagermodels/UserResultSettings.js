...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/UserResultSettings
   * @version 2.0
   */

  /**
   * Constructs a new <code>UserResultSettings</code>.
   * @alias module:radiomanager/radiomanagermodels/UserResultSettings
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/UserResultSettings} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/UserResultSettings} The populated <code>UserResultSettings</code> instance.
   */
