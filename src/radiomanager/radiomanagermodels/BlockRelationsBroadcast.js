...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/BlockRelationsBroadcast
   * @version 2.0
   */

  /**
   * Constructs a new <code>BlockRelationsBroadcast</code>.
   * @alias module:radiomanager/radiomanagermodels/BlockRelationsBroadcast
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/BlockRelationsBroadcast} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BlockRelationsBroadcast} The populated <code>BlockRelationsBroadcast</code> instance.
   */
