...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/ProgramFieldValues'], factory);
   ...
   * @module radiomanager/radiomanagermodels/Program
   * @version 2.0
   */

  /**
   * Constructs a new <code>Program</code>.
   * @alias module:radiomanager/radiomanagermodels/Program
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/Program} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/Program} The populated <code>Program</code> instance.
   */
  ...
  /**
   * @return {module:radiomanager/radiomanagermodels/ProgramFieldValues}
   */
  ...
  /**
   * @param {module:radiomanager/radiomanagermodels/ProgramFieldValues} fieldValues
   */
