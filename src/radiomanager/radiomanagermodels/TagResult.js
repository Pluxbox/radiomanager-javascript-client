...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Tag', 'radiomanager/radiomanagermodels/TagOutputOnly', 'radiomanager/radiomanagermodels/TagRelations', 'radiomanager/radiomanagermodels/TagRelationsBroadcasts', 'radiomanager/radiomanagermodels/TagRelationsContacts', 'radiomanager/radiomanagermodels/TagRelationsItems', 'radiomanager/radiomanagermodels/TagRelationsPrograms'], factory);
   ...
   * @module radiomanager/radiomanagermodels/TagResult
   * @version 2.0
   */

  /**
   * Constructs a new <code>TagResult</code>.
   * @alias module:radiomanager/radiomanagermodels/TagResult
   * @class
   * @implements module:radiomanager/radiomanagermodels/TagOutputOnly
   * @implements module:radiomanager/radiomanagermodels/Tag
   * @implements module:radiomanager/radiomanagermodels/TagRelations
   * @param id {Number} 
   * @param name {String} 
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/TagResult} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/TagResult} The populated <code>TagResult</code> instance.
   */
