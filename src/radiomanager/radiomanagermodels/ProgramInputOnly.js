...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ProgramInputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramInputOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/ProgramInputOnly
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ProgramInputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ProgramInputOnly} The populated <code>ProgramInputOnly</code> instance.
   */
