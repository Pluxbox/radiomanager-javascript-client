...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/ItemResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ItemResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.ItemResults = factory(root.radiomanager.ApiClient, root.radiomanager.ItemResult);
  }
}(this, function(ApiClient, ItemResult) {
  'use strict';
  ...
  /**
   * The ItemResults model module.
   * @module radiomanager/radiomanagermodels/ItemResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ItemResults</code>.
   * @alias module:radiomanager/radiomanagermodels/ItemResults
   * @class
   */
  ...
  /**
   * Constructs a <code>ItemResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/ItemResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ItemResults} The populated <code>ItemResults</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ItemResult]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/ItemResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/ItemResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/ItemResult>} results
   */
