...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.radiomanager.TagOutputOnly = factory(root.radiomanager.ApiClient);
  }
   ...
   * @module radiomanager/radiomanagermodels/TagOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>TagOutputOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/TagOutputOnly
   * @class
   * @param id {Number} 
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/TagOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/TagOutputOnly} The populated <code>TagOutputOnly</code> instance.
   */
