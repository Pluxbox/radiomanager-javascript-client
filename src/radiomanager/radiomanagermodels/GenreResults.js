...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/GenreResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GenreResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.GenreResults = factory(root.radiomanager.ApiClient, root.radiomanager.GenreResult);
  }
}(this, function(ApiClient, GenreResult) {
  'use strict';
  ...
  /**
   * The GenreResults model module.
   * @module radiomanager/radiomanagermodels/GenreResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>GenreResults</code>.
   * @alias module:radiomanager/radiomanagermodels/GenreResults
   * @class
   */
  ...
  /**
   * Constructs a <code>GenreResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/GenreResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/GenreResults} The populated <code>GenreResults</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [GenreResult]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/GenreResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/GenreResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/GenreResult>} results
   */
