...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/ProgramResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProgramResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.ProgramResults = factory(root.radiomanager.ApiClient, root.radiomanager.ProgramResult);
  }
}(this, function(ApiClient, ProgramResult) {
  'use strict';
  ...
  /**
   * The ProgramResults model module.
   * @module radiomanager/radiomanagermodels/ProgramResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramResults</code>.
   * @alias module:radiomanager/radiomanagermodels/ProgramResults
   * @class
   */
  ...
  /**
   * Constructs a <code>ProgramResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/ProgramResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ProgramResults} The populated <code>ProgramResults</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ProgramResult]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/ProgramResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/ProgramResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/ProgramResult>} results
   */
