...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/PresenterRelationsBroadcasts
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterRelationsBroadcasts</code>.
   * @alias module:radiomanager/radiomanagermodels/PresenterRelationsBroadcasts
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/PresenterRelationsBroadcasts} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/PresenterRelationsBroadcasts} The populated <code>PresenterRelationsBroadcasts</code> instance.
   */
