...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Genre', 'radiomanager/radiomanagermodels/GenreOutputOnly', 'radiomanager/radiomanagermodels/GenreRelations', 'radiomanager/radiomanagermodels/GenreRelationsBroadcasts', 'radiomanager/radiomanagermodels/GenreRelationsPrograms'], factory);
   ...
   * @module radiomanager/radiomanagermodels/GenreResult
   * @version 2.0
   */

  /**
   * Constructs a new <code>GenreResult</code>.
   * @alias module:radiomanager/radiomanagermodels/GenreResult
   * @class
   * @implements module:radiomanager/radiomanagermodels/Genre
   * @implements module:radiomanager/radiomanagermodels/GenreRelations
   * @implements module:radiomanager/radiomanagermodels/GenreOutputOnly
   * @param id {Number} 
   * @param name {String} 
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/GenreResult} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/GenreResult} The populated <code>GenreResult</code> instance.
   */
