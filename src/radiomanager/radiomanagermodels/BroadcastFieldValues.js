...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/BroadcastFieldValues
   * @version 2.0
   */

  /**
   * Constructs a new <code>BroadcastFieldValues</code>.
   * @alias module:radiomanager/radiomanagermodels/BroadcastFieldValues
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/BroadcastFieldValues} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BroadcastFieldValues} The populated <code>BroadcastFieldValues</code> instance.
   */
