...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/CampaignResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CampaignResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.CampaignResults = factory(root.radiomanager.ApiClient, root.radiomanager.CampaignResult);
  }
}(this, function(ApiClient, CampaignResult) {
  'use strict';
  ...
  /**
   * The CampaignResults model module.
   * @module radiomanager/radiomanagermodels/CampaignResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>CampaignResults</code>.
   * @alias module:radiomanager/radiomanagermodels/CampaignResults
   * @class
   */
  ...
  /**
   * Constructs a <code>CampaignResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/CampaignResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/CampaignResults} The populated <code>CampaignResults</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [CampaignResult]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/CampaignResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/CampaignResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/CampaignResult>} results
   */
