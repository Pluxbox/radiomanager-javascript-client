...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Program', 'radiomanager/radiomanagermodels/ProgramFieldValues', 'radiomanager/radiomanagermodels/ProgramInputOnly'], factory);
   ...
   * @module radiomanager/radiomanagermodels/ProgramDataInput
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramDataInput</code>.
   * @alias module:radiomanager/radiomanagermodels/ProgramDataInput
   * @class
   * @implements module:radiomanager/radiomanagermodels/Program
   * @implements module:radiomanager/radiomanagermodels/ProgramInputOnly
   ...
   * @param {module:radiomanager/radiomanagermodels/ProgramDataInput} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ProgramDataInput} The populated <code>ProgramDataInput</code> instance.
   */
