...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/InviteUserData
   * @version 2.0
   */

  /**
   * Constructs a new <code>InviteUserData</code>.
   * @alias module:radiomanager/radiomanagermodels/InviteUserData
   * @class
   * @param email {String} 
   * @param roleId {Number} 
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/InviteUserData} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/InviteUserData} The populated <code>InviteUserData</code> instance.
   */
