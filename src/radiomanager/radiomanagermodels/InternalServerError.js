...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/InternalServerError
   * @version 2.0
   */

  /**
   * Constructs a new <code>InternalServerError</code>.
   * @alias module:radiomanager/radiomanagermodels/InternalServerError
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/InternalServerError} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/InternalServerError} The populated <code>InternalServerError</code> instance.
   */
