...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/BlockRelationsItemsParams
   * @version 2.0
   */

  /**
   * Constructs a new <code>BlockRelationsItemsParams</code>.
   * @alias module:radiomanager/radiomanagermodels/BlockRelationsItemsParams
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/BlockRelationsItemsParams} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BlockRelationsItemsParams} The populated <code>BlockRelationsItemsParams</code> instance.
   */
