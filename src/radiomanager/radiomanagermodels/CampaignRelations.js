...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/BroadcastRelationsModelType', 'radiomanager/radiomanagermodels/CampaignRelationsItems'], factory);
   ...
   * @module radiomanager/radiomanagermodels/CampaignRelations
   * @version 2.0
   */

  /**
   * Constructs a new <code>CampaignRelations</code>.
   * @alias module:radiomanager/radiomanagermodels/CampaignRelations
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/CampaignRelations} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/CampaignRelations} The populated <code>CampaignRelations</code> instance.
   */
  ...
  /**
   * @return {module:radiomanager/radiomanagermodels/CampaignRelationsItems}
   */
  ...
  /**
   * @param {module:radiomanager/radiomanagermodels/CampaignRelationsItems} items
   */
