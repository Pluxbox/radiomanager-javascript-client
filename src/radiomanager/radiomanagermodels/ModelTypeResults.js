...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/ModelTypeResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ModelTypeResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.ModelTypeResults = factory(root.radiomanager.ApiClient, root.radiomanager.ModelTypeResult);
  }
}(this, function(ApiClient, ModelTypeResult) {
  'use strict';
  ...
  /**
   * The ModelTypeResults model module.
   * @module radiomanager/radiomanagermodels/ModelTypeResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeResults</code>.
   * @alias module:radiomanager/radiomanagermodels/ModelTypeResults
   * @class
   */
  ...
  /**
   * Constructs a <code>ModelTypeResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/ModelTypeResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ModelTypeResults} The populated <code>ModelTypeResults</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ModelTypeResult]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/ModelTypeResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/ModelTypeResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/ModelTypeResult>} results
   */
