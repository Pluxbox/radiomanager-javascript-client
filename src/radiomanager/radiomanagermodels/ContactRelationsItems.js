...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ContactRelationsItems
   * @version 2.0
   */

  /**
   * Constructs a new <code>ContactRelationsItems</code>.
   * @alias module:radiomanager/radiomanagermodels/ContactRelationsItems
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ContactRelationsItems} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ContactRelationsItems} The populated <code>ContactRelationsItems</code> instance.
   */
