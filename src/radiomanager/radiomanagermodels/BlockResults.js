...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/BlockResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BlockResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.BlockResults = factory(root.radiomanager.ApiClient, root.radiomanager.BlockResult);
  }
}(this, function(ApiClient, BlockResult) {
  'use strict';
  ...
  /**
   * The BlockResults model module.
   * @module radiomanager/radiomanagermodels/BlockResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>BlockResults</code>.
   * @alias module:radiomanager/radiomanagermodels/BlockResults
   * @class
   */
  ...
  /**
   * Constructs a <code>BlockResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/BlockResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BlockResults} The populated <code>BlockResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/BlockResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/BlockResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/BlockResult>} results
   */
