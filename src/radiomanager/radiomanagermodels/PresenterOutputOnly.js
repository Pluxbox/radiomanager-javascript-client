...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/PresenterOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterOutputOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/PresenterOutputOnly
   * @class
   * @param id {Number} 
   ...
   * @param {module:radiomanager/radiomanagermodels/PresenterOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/PresenterOutputOnly} The populated <code>PresenterOutputOnly</code> instance.
   */
