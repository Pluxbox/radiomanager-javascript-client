...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.radiomanager.ProgramOutputOnly = factory(root.radiomanager.ApiClient);
  }
   ...
   * @module radiomanager/radiomanagermodels/ProgramOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>ProgramOutputOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/ProgramOutputOnly
   * @class
   * @param id {Number} 
   ...
   * @param {module:radiomanager/radiomanagermodels/ProgramOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ProgramOutputOnly} The populated <code>ProgramOutputOnly</code> instance.
   */
