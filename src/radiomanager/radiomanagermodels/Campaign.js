...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/Campaign
   * @version 2.0
   */

  /**
   * Constructs a new <code>Campaign</code>.
   * @alias module:radiomanager/radiomanagermodels/Campaign
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/Campaign} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/Campaign} The populated <code>Campaign</code> instance.
   */
