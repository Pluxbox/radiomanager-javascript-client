...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/ModelTypeOutputOnly
   * @version 2.0
   */

  /**
   * Constructs a new <code>ModelTypeOutputOnly</code>.
   * @alias module:radiomanager/radiomanagermodels/ModelTypeOutputOnly
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/ModelTypeOutputOnly} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/ModelTypeOutputOnly} The populated <code>ModelTypeOutputOnly</code> instance.
   */
