...
(function(root, factory) {
   ...
   * @module radiomanager/radiomanagermodels/TagRelationsBroadcastsParams
   * @version 2.0
   */

  /**
   * Constructs a new <code>TagRelationsBroadcastsParams</code>.
   * @alias module:radiomanager/radiomanagermodels/TagRelationsBroadcastsParams
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/TagRelationsBroadcastsParams} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/TagRelationsBroadcastsParams} The populated <code>TagRelationsBroadcastsParams</code> instance.
   */
