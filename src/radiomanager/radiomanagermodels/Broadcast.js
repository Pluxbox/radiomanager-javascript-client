...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/BroadcastFieldValues'], factory);
   ...
   * @module radiomanager/radiomanagermodels/Broadcast
   * @version 2.0
   */

  /**
   * Constructs a new <code>Broadcast</code>.
   * @alias module:radiomanager/radiomanagermodels/Broadcast
   * @class
   */
   ...
   * @param {module:radiomanager/radiomanagermodels/Broadcast} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/Broadcast} The populated <code>Broadcast</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('repetition_days')) {
        obj['repetition_days'] = ApiClient.convertToType(data['repetition_days'], ['Boolean']);
      }
  ...
  /**
   * @return {module:radiomanager/radiomanagermodels/BroadcastFieldValues}
   */
  ...
  /**
   * @param {module:radiomanager/radiomanagermodels/BroadcastFieldValues} fieldValues
   */
  ...
  /**
   * @return {module:radiomanager/radiomanagermodels/Broadcast.RepetitionTypeEnum}
   */
  ...
  /**
   * @param {module:radiomanager/radiomanagermodels/Broadcast.RepetitionTypeEnum} repetitionType
   */
  ...
  /**
   * @param {Array.<Boolean>} repetitionDays
   */
