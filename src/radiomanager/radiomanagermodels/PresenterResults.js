...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/PresenterResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PresenterResult'));
  } else {
    // Browser globals (root is window)
    if (!root.radiomanager) {
      root.radiomanager = {};
    }
    root.radiomanager.PresenterResults = factory(root.radiomanager.ApiClient, root.radiomanager.PresenterResult);
  }
}(this, function(ApiClient, PresenterResult) {
  'use strict';
  ...
  /**
   * The PresenterResults model module.
   * @module radiomanager/radiomanagermodels/PresenterResults
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterResults</code>.
   * @alias module:radiomanager/radiomanagermodels/PresenterResults
   * @class
   */
  ...
  /**
   * Constructs a <code>PresenterResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:radiomanager/radiomanagermodels/PresenterResults} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/PresenterResults} The populated <code>PresenterResults</code> instance.
   */
  ...
  /**
   * @member {Array.<module:radiomanager/radiomanagermodels/PresenterResult>} results
   */
  ...
  /**
   * @return {Array.<module:radiomanager/radiomanagermodels/PresenterResult>}
   */
  ...
  /**
   * @param {Array.<module:radiomanager/radiomanagermodels/PresenterResult>} results
   */
