...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Block', 'radiomanager/radiomanagermodels/BlockRelations', 'radiomanager/radiomanagermodels/BlockRelationsBroadcast', 'radiomanager/radiomanagermodels/BlockRelationsItems', 'radiomanager/radiomanagermodels/BlockRelationsProgram'], factory);
   ...
   * @module radiomanager/radiomanagermodels/BlockResult
   * @version 2.0
   */

  /**
   * Constructs a new <code>BlockResult</code>.
   * @alias module:radiomanager/radiomanagermodels/BlockResult
   * @class
   * @implements module:radiomanager/radiomanagermodels/Block
   * @implements module:radiomanager/radiomanagermodels/BlockRelations
   ...
   * @param {module:radiomanager/radiomanagermodels/BlockResult} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/BlockResult} The populated <code>BlockResult</code> instance.
   */
