...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['radiomanager/ApiClient', 'radiomanager/radiomanagermodels/Presenter'], factory);
   ...
   * @module radiomanager/radiomanagermodels/PresenterDataInput
   * @version 2.0
   */

  /**
   * Constructs a new <code>PresenterDataInput</code>.
   * @alias module:radiomanager/radiomanagermodels/PresenterDataInput
   * @class
   ...
   * @param {module:radiomanager/radiomanagermodels/PresenterDataInput} obj Optional instance to populate.
   * @return {module:radiomanager/radiomanagermodels/PresenterDataInput} The populated <code>PresenterDataInput</code> instance.
   */
